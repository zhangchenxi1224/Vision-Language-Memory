...
def main():
    ...
    generated_source = a.logical_sampling_commit == 'b62ec027ad725aeb6ecc772aa85e7a3ff6e49b36'
    ...
    if fresh_validation:
        if native_baseline:
            ...
            expected_parent = 'b62ec02-generated-source-full4832' if generated_source else '4fbc857-clear-retention-full4832'
    ...
    try:
        ...
        if a.logical_sampling_commit in ('b9f90e956eea7bda15f638c8877919941ce4fec5', '4fbc85725d78427235757ace2661d086b896a97f', 'b62ec027ad725aeb6ecc772aa85e7a3ff6e49b36') and not fresh_validation:
