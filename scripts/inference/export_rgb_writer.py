...
p.add_argument('--inference-condition', choices=('native', 'training_raw'), default='native')
a = p.parse_args()
manifest = export_completed_writer(a.parent_run, a.output, inference_condition=a.inference_condition)
