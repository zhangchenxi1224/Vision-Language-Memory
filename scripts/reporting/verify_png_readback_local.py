...
def verify(readback_archive, readback_sha256, source_archive, source_sha256, expected_commit, *, continuation_validation_commit=None, continuation_training_commit=None):
    ...
    try:
        with tempfile.TemporaryDirectory(prefix='png-readback-evidence-', dir=ROOT / '.cache') as directory:
            ...
            result = collect(run, expected_commit=expected_commit, source=source,
                continuation_validation_commit=continuation_validation_commit, continuation_training_commit=continuation_training_commit)
