...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "data" / "synthetic_v2")
    ...
    parser.add_argument(
        ...
        default="full",
        help="Generate the full transition corpus or the separate SET/NOOP curriculum.",
    )
    ...
    manifest = generate_dataset(
        ...
        sizes=sizes,
        seed=args.seed,
        transition_profile=args.transition_profile.replace("-", "_"),
    )
