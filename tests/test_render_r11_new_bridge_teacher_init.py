...
from scripts.experiments import render_r11_new_canonical_latent_bridge_teacher_init_delivery as delivery  # noqa: E402
from vision_memory.data import REVERSE_CYCLIC4  # noqa: E402


COMMIT = "5bffcb9a1605c7cdef77df1126daca6f9578bdda"
...
def _fixture(tmp_path: Path, monkeypatch: pytest.MonkeyPatch, *, endpoint_correct: bool = False,
    ...
    for label, root in (("preflight", preflight), ("formal", formal)):
        artifact = root / "run" / "initialization" / "teacher_matched_initialization.pt"
        ...
        initialization[label] = {"passed": True, "compute_device_type": "cuda",
                                 ...
                                 "trajectory_point0_teacher_normalized_rmse": 0.002}
    preflight_report = {
